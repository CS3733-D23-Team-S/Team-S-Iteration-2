...
public class NewSubmittedRoomRequestController implements Initializable {
  ...
  public void initialize(URL location, ResourceBundle resources) {
    ...
    roomBooked.setCellValueFactory(
        (row) -> new SimpleStringProperty(row.getValue().getRoomBooked()));
    timeBooked.setCellValueFactory(
        (row) -> new SimpleStringProperty(row.getValue().getTimeBooked()));
